...
Function Set-WinVMIP ($VM, $GC, $IP, $SNM, $GW){
 $netsh = "c:\windows\system32\netsh.exe interface ip set address ""Local Area Connection 100"" static $IP $SNM $GW 1"
...
Import-Csv "C:\Users\Administrator\Documents\powershell\vm_ip.csv" -UseCulture | %{
  $VM = Get-VM $_.VMname
